 ...
 * @author rblanco
 */
public class OSMHandler extends WMSHandler {
    ...
    public String buildQuery(final Extent e, final int zoomLevel, final double resolution) {
        ...
        StringBuffer query = new StringBuffer().append(getURL())
                ...
                .append("/").append(tileN.getX())
                .append("/").append(tileN.getY())
                .append(".png");
    ...
    public Pixel getTileNumber(final Extent e, final int zoomLevel, final double resolution, final Projection proj) {
        ...
        return TileConversor.getTileNumber(p.getX(), p.getY(), zoomLevel);        
    }
    
    
    /**
     * Calculates an extent that contains a given Point
     * @param center The point to be contained by the extent calculated
     * @param resolution The current resolution of the layer
     * @param origin The origin of the layer (leftBottom corner)
     * @return
     */
