...
public class Config {
	...
	private static boolean isValid() {
		try {			
			...
			if (!Config.checkNotNull(String.valueOf(Config.getInstance().getGPSTimerDelay()))){
				return false;
			}
			
			if (!Config.checkNotNull(String.valueOf(Config.getInstance().getLastTime()))){
				return false;
			}
			
			if (!Config.checkNotNull(String.valueOf(Config.getInstance().getLogLevel()))){
				return false;
			}
			
			if (!Config.checkNotNull(String.valueOf(Config.getInstance().getPort()))){
				return false;
			}
			
			if (!Config.checkNotNull(String.valueOf(Config.getInstance().getRetryFail()))){
				return false;
			}
			
			if (!Config.checkNotNull(String.valueOf(Config.getInstance().getWakeTime()))){
				return false;
			}
	...
	public int getPort() throws NoSuchFieldError {
		try {			
			return new Integer(properties.get(Config.PORT_TAG).toString()).intValue();
		} catch (Exception e) {
	...
	public int getLogLevel() throws NoSuchFieldError {
		try {
			return new Integer(properties.get(Config.LOG_TAG).toString()).intValue();
		} catch (Exception e) {
	...
	public int getRetryFail() throws NoSuchFieldError {
		try {			
			return new Integer(properties.get(Config.RETRYFAIL_TAG).toString()).intValue();
		} catch (Exception e) {
	...
	public int getWakeTime() throws NoSuchFieldError {
		try {			
			return new Integer(properties.get(Config.WAKETIME_TAG).toString()).intValue();
		} catch (Exception e) {
	...
	public int getLastTime() throws NoSuchFieldError {
		try {			
			return new Integer(properties.get(Config.LASTTIME_TAG).toString()).intValue();
		} catch (Exception e) {
	...
	public int getGPSTimerDelay() throws NoSuchFieldError {
		try {			
			return new Integer(properties.get(Config.GPSTIMER_TAG).toString()).intValue();
		} catch (Exception e) {
	...
	public int getUseNetWorkLocation() throws NoSuchFieldError {
		try {			
			return Integer.valueOf(properties.get(Config.USENETWORK_TAG).toString()).intValue();
		} catch (Exception e) {
	...
	public int getMinTime() throws NoSuchFieldError {
		try {			
			int res = Integer.valueOf(properties.get(Config.MINTIME_TAG).toString()).intValue();
			if (res < 0)
				res = 0;
			return res;
		} catch (Exception e) {
	...
	public int getMinDistance() throws NoSuchFieldError {
		try {			
			int res = Integer.valueOf(properties.get(Config.MINDISTANCE_TAG).toString()).intValue();
			if (res < 0)
				res = 0;
			return res;
		} catch (Exception e) {
	...
	public boolean isUseNetWorkLocation() throws NoSuchFieldError {
		try {			
			return Boolean.valueOf(properties.get(Config.USENETWORK_TAG).toString()).booleanValue();
		} catch (Exception e) {
			throw new NoSuchFieldError(Config.USENETWORK_TAG);
		}
	}
	...
	public int getSendMessagePeriod() throws NoSuchFieldError {
		try {
			return Integer.valueOf(properties.get(Config.SENDPERIOD_TAG).toString()).intValue();
		} catch (Exception e) {
	...
	public static void persist() {
		try {
			...
			out.write(Config.SERVER_TAG+"="+Config.getInstance().getServer()+"\n");
			out.write(Config.USER_TAG+"="+Config.getInstance().getUser()+"\n");
			out.write(Config.PASS_TAG+"="+Config.getInstance().getPass()+"\n");
			out.write(Config.DOMAIN_TAG+"="+Config.getInstance().getDomain()+"\n");
			out.write(Config.PORT_TAG+"="+Config.getInstance().getPort()+"\n");
			out.write(Config.LOG_TAG+"="+Config.getInstance().getLogLevel()+"\n");
			out.write(Config.RETRYFAIL_TAG+"="+Config.getInstance().getRetryFail()+"\n");
			out.write(Config.WAKETIME_TAG+"="+Config.getInstance().getWakeTime()+"\n");
			out.write(Config.LASTTIME_TAG+"="+Config.getInstance().getLastTime()+"\n");
			out.write(Config.GPSTIMER_TAG+"="+Config.getInstance().getGPSTimerDelay()+"\n");
			out.write(Config.TO_TAG+"="+Config.getInstance().getTo()+"\n");
			out.write(Config.USERADDRESS_TAG+"="+Config.getInstance().getUserAddress()+"\n");
			out.write(Config.USERNAME_TAG+"="+Config.getInstance().getUserName()+"\n");
			out.write(Config.USENETWORK_TAG+"="+Config.getInstance().getUseNetWorkLocation()+"\n");
			out.write(Config.SENDPERIOD_TAG+"="+Config.getInstance().getSendMessagePeriod()+"\n");
			out.write(Config.MINTIME_TAG+"="+Config.getInstance().getMinTime()+"\n");
			out.write(Config.MINDISTANCE_TAG+"="+Config.getInstance().getMinDistance());
			out.close();		
