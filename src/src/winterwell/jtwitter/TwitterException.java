 ...
 * problems. Error handling is particulalry important as Twitter tends to be a
 * bit flaky.
 * <p>
...
public class TwitterException extends RuntimeException {
	...
	/**
	 * Indicates a 404: resource does not exist error from Twitter. Note: Can be
	 * throw in relation to suspended users.
	 */
