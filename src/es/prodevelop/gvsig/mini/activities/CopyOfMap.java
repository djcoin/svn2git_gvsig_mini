 ...
 * 
 */
public class CopyOfMap extends MapLocation implements GeoUtils, IDownloadWaiter,
	...
	private final static Logger log = Logger.getLogger(CopyOfMap.class.getName());
...
//			pMenu.add(0, 12, 12, R.string.bookmarks);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		try {
			...
			case 0:
				try {
					CopyOfMap.this.showSearchDialog();
				} catch (Exception e) {
			...
			case 4:
				if (Utils.isSDMounted()) {
					if (osmap.getMRendererInfo().allowsMassiveDownload()) {
						CopyOfMap.this.showDownloadTilesDialog();
					} else {
			...
			r.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(RadioGroup arg0, int arg1) {
					try {
						...
						CopyOfMap.this.osmap.setZoomLevel(17, true);
						switch (arg1) {
						case 0:
	...
	public void showWeather(WeatherSet ws) {
		try {
			...
			if (ws == null) {
				...
				Toast.makeText(CopyOfMap.this, R.string.Map_8, Toast.LENGTH_LONG)
						.show();
				return;
			}
	...
	public void updateZoomControl() {
		try {
			MapRenderer r = CopyOfMap.this.osmap.getMRendererInfo();
			...
			s.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
				...
				public void onProgressChanged(SeekBar seekBar, int progress,
					...
					int zoom = (int) Math.floor(progress
							* (CopyOfMap.this.osmap.getMRendererInfo()
									.getZOOM_MAXLEVEL() + 1 - CopyOfMap.this.osmap
				...
				public void onStopTrackingTouch(SeekBar seekBar) {
					try {
						...
						CopyOfMap.this.updateSlider(zoom);
						CopyOfMap.this.osmap.setZoomLevel(zoom, true);
						CopyOfMap.this.osmap.cleanZoomRectangle();
					} catch (Exception e) {
	...
	class MapHandler extends Handler {
		...
		public void handleMessage(final Message msg) {
			try {
				...
				switch (what) {
				case CopyOfMap.SHOW_LOADING:
					setLoadingVisible(true);
					break;
				case CopyOfMap.HIDE_LOADING:
				...
				case TaskHandler.NO_RESPONSE:
					...
					if (dialog2 != null)
						dialog2.dismiss();
					Toast.makeText(CopyOfMap.this, R.string.Map_22, Toast.LENGTH_LONG)
							.show();
					break;
				case CopyOfMap.SHOW_TOAST:
					log.log(Level.FINE, "SHOW_TOAST");
					Toast t = Toast.makeText(CopyOfMap.this, msg.obj.toString(),
							Toast.LENGTH_LONG);
					t.show();
					if (dialog2 != null)
						dialog2.dismiss();
					break;
				case CopyOfMap.SHOW_OK_DIALOG:
					log.log(Level.FINE, "SHOW_OK_DIALOG");
					if (dialog2 != null)
						dialog2.dismiss();
					CopyOfMap.this.showOKDialog(msg.obj.toString(),
							R.string.getFeatureInfo, true);
					break;
				case CopyOfMap.POI_LIST:
					log.log(Level.FINE, "POI_LIST");
					CopyOfMap.this.viewLastPOIs();
					break;
				case CopyOfMap.POI_CLEARED:
					log.log(Level.FINE, "POI_CLEARED");
					CopyOfMap.this.updateContext(CopyOfMap.POI_CLEARED);
					break;
				case CopyOfMap.ROUTE_CLEARED:
					log.log(Level.FINE, "ROUTE_CLEARED");
					CopyOfMap.this.updateContext(CopyOfMap.ROUTE_CLEARED);
					break;
				case CopyOfMap.WEATHER_INITED:
					log.log(Level.FINE, "WEATHER_INITED");
					dialog2 = ProgressDialog.show(CopyOfMap.this, CopyOfMap.this
							.getResources().getString(R.string.please_wait),
							CopyOfMap.this.getResources().getString(R.string.Map_14),
							true);
					...
					dialog2.setOnCancelListener(new OnCancelListener() {
						...
						public void onCancel(DialogInterface dialog2) {
							try {
								...
								CopyOfMap.this.getItemContext().cancelCurrentTask();
								dialog2.dismiss();
							} catch (Exception e) {
					...
					break;
				case CopyOfMap.GETFEATURE_INITED:
				...
				case CopyOfMap.WEATHER_CANCELED:
					log.log(Level.FINE, "WEATHER_CANCELED");
					Toast.makeText(CopyOfMap.this, R.string.Map_15, Toast.LENGTH_LONG)
							.show();
					break;
				case CopyOfMap.WEATHER_ERROR:
					...
					if (dialog2 != null)
						dialog2.dismiss();
					break;
				case CopyOfMap.WEATHER_SHOW:
					log.log(Level.FINE, "WEATHER_SHOW");
					Functionality f = CopyOfMap.this.getItemContext()
							.getExecutingFunctionality();
					if (f instanceof WeatherFunctionality)
						CopyOfMap.this.showWeather(((WeatherFunctionality) f).ws);
					else {
						log.log(Level.FINE, "Nof found Weather functionality");
					}
					break;
				case CopyOfMap.ROUTE_NO_RESPONSE:
					log.log(Level.FINE, "ROUTE_NO_RESPONSE");
					Toast.makeText(CopyOfMap.this, R.string.server_busy,
							Toast.LENGTH_LONG).show();
					// ivCleanRoute.setVisibility(View.INVISIBLE);
					if (dialog2 != null)
						dialog2.dismiss();
					break;
				case CopyOfMap.ROUTE_SUCCEEDED:
					...
					osmap.getMRendererInfo().reprojectGeometryCoordinates(
							...
							"EPSG:4326");
					CopyOfMap.this.updateContext(CopyOfMap.ROUTE_SUCCEEDED);
					osmap.resumeDraw();
					break;
				case CopyOfMap.ROUTE_NO_CALCULATED:
					log.log(Level.FINE, "ROUTE_NO_CALCULATED");
					Toast.makeText(CopyOfMap.this, R.string.Map_16, Toast.LENGTH_LONG)
							.show();
					// ivCleanRoute.setVisibility(View.INVISIBLE);
					if (dialog2 != null)
						dialog2.dismiss();
					break;
				case CopyOfMap.POI_SHOW:
					...
					if (nf instanceof NameFinderFunc) {
						...
						osmap.getMRendererInfo().reprojectGeometryCoordinates(
								n.nm, "EPSG:4326");
						boolean update = CopyOfMap.this.showPOIs(n.desc, n.nm);
						if (update)
							CopyOfMap.this.updateContext(CopyOfMap.POI_SUCCEEDED);
					} else {
						log.log(Level.FINE,
								"Nof found NameFinder functionality");
					}
					break;
				case CopyOfMap.POI_INITED:
					log.log(Level.FINE, "POI_INITED");
					dialog2 = ProgressDialog.show(CopyOfMap.this, CopyOfMap.this
							.getResources().getString(R.string.please_wait),
							CopyOfMap.this.getResources().getString(R.string.Map_17),
							true);
					dialog2.setCancelable(true);
					dialog2.setCanceledOnTouchOutside(true);
				...
				case CopyOfMap.ROUTE_CANCELED:
					...
					if (dialog2 != null)
						dialog2.dismiss();
					// ivCleanRoute.setVisibility(View.INVISIBLE);
					Toast.makeText(CopyOfMap.this, R.string.Map_18, Toast.LENGTH_LONG)
							.show();
					osmap.postInvalidate();
					break;
				case CopyOfMap.POI_CANCELED:
					log.log(Level.FINE, "POI_CANCELED");
					// ivCleanPois.setVisibility(View.INVISIBLE);
					// ivShowList.setVisibility(View.INVISIBLE);
					if (dialog2 != null)
						dialog2.dismiss();
					Toast.makeText(CopyOfMap.this, R.string.task_canceled,
							Toast.LENGTH_LONG).show();
					nameds = null;
					osmap.postInvalidate();
					break;
				case CopyOfMap.CALCULATE_ROUTE:
					log.log(Level.FINE, "CALCULATE_ROUTE");
					CopyOfMap.this.calculateRoute();
					break;
				case CopyOfMap.ROUTE_INITED:
					log.log(Level.FINE, "ROUTE_INITED");
					RouteManager.getInstance().getRegisteredRoute()
							.deleteRoute(false);
					dialog2 = ProgressDialog.show(CopyOfMap.this, CopyOfMap.this
							.getResources().getString(R.string.please_wait),
							CopyOfMap.this.getResources().getString(R.string.Map_19),
							true);
					dialog2.setCancelable(true);
					dialog2.setCanceledOnTouchOutside(true);
					...
					break;
				case CopyOfMap.TWEET_SENT:
					log.log(Level.FINE, "TWEET_SENT");
					Toast.makeText(CopyOfMap.this, R.string.Map_20, Toast.LENGTH_LONG)
							.show();
					break;
				case CopyOfMap.TWEET_ERROR:
					log.log(Level.FINE, "TWEET_ERROR");
					Toast t1 = Toast.makeText(CopyOfMap.this, msg.obj.toString(),
							Toast.LENGTH_LONG);
					t1.show();
					break;
				case CopyOfMap.SHOW_TWEET_DIALOG:
					log.log(Level.FINE, "SHOW_TWEET_DIALOG");
					CopyOfMap.this.showTweetDialog();
					break;
				case CopyOfMap.SHOW_TWEET_DIALOG_SETTINGS:
					log.log(Level.FINE, "SHOW_TWEET_DIALOG_SETTINGS");
					CopyOfMap.this.showTweetDialogSettings();
					break;
				case CopyOfMap.SHOW_POI_DIALOG:
					log.log(Level.FINE, "SHOW_POI_DIALOG");
					CopyOfMap.this.showPOIDialog();
					break;
				case CopyOfMap.SHOW_ADDRESS_DIALOG:
	...
	private void instantiateTileDownloaderTask(LinearLayout l, int progress) {
		try {
			...
			MapRenderer currentRenderer = CopyOfMap.this.osmap.getMRendererInfo();
			...
			CopyOfMap.this.totalZoom.setText(CopyOfMap.this
			...
			this.downTilesSeekBar
					.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
						...
						public void onProgressChanged(SeekBar arg0,
							...
							try {
								CopyOfMap.this.instantiateTileDownloaderTask(l,
										progress);
			...
			((CheckBox) l.findViewById(R.id.download_tiles_overwrite_check))
					.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View arg0) {
							CopyOfMap.this.instantiateTileDownloaderTask(l,
									CopyOfMap.this.downTilesSeekBar.getProgress());
						}
					});
			...
			alert.setPositiveButton(R.string.download_tiles_14,
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
								int whichButton) {
							try {
								CopyOfMap.this.resetCounter();
								CopyOfMap.this.downloadTileAlert = CopyOfMap.this
										.getDownloadTilesDialog();
								CopyOfMap.this.downloadTileAlert.show();
			...
			alert.setNegativeButton(R.string.alert_dialog_text_cancel,
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
							...
							// setRequestedOrientation(ActivityInfo.
							// SCREEN_ORIENTATION_SENSOR);
							CopyOfMap.this.osmap.resumeDraw();
							CopyOfMap.this.reloadLayerAfterDownload();
						}
					});
	...
	private AlertDialog getDownloadTilesDialog() {
		...
		builder.setOnKeyListener(new OnKeyListener() {
			...
			public boolean onKey(DialogInterface arg0, int arg1, KeyEvent arg2) {
				if (arg2.getKeyCode() == KeyEvent.KEYCODE_BACK) {
					Toast.makeText(CopyOfMap.this, R.string.download_tiles_13,
							Toast.LENGTH_LONG).show();
				}
				return true;
			}
		...
		downloadTilesButton.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				CopyOfMap.this.downloadCancellable.setCanceled(true);
				CopyOfMap.this.downloadTileAlert.dismiss();
			}
		});
							...
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									try {
										...
										CopyOfMap.twituser = userName;
										CopyOfMap.twitpass = userPass;
					...
					.setPositiveButton(R.string.ok,
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
										int whichButton) {
									try {
										Intent i = new Intent(CopyOfMap.this,
		...
		try {
			int progress = Math
					.round(this.osmap.getTempZoomLevel()
							* 100
							/ (this.osmap.getMRendererInfo().getZOOM_MAXLEVEL() + 1 - CopyOfMap.this.osmap
									.getMRendererInfo().getZoomMinLevel()));
			// if (progress == 0)
			// progress = 1;
	...
	private int state = CopyOfMap.VOID;
		...
		try {
			runOnUiThread(new Runnable() {
				public void run() {
					...
					CopyOfMap.this.downloadTilesPB.setMax((int) tileWaiter
							.getTotalTilesToProcess());
					CopyOfMap.this.downloadTilesPB.setProgress((int) tileWaiter
							.getDownloadedNow());
					long totalDownloaded = CopyOfMap.this.tileWaiter
							.getDownloadedNow();
					long total = CopyOfMap.this.tileWaiter.getTotalTilesToProcess();
					int perc = 0;
					if (total != 0)
						perc = (int) ((double) totalDownloaded / (double) total * 100.0);

					((TextView) CopyOfMap.this.downloadTilesLayout
					...
					String downloadedMB = String.valueOf(CopyOfMap.this.tileWaiter
	...
	public void onDownloadCanceled() {
		...
		runOnUiThread(new Runnable() {
			public void run() {
				CopyOfMap.this.enableGPS();
				Toast.makeText(CopyOfMap.this, R.string.download_tiles_12,
						Toast.LENGTH_LONG).show();
				CopyOfMap.this.reloadLayerAfterDownload();
			}
		});
	...
	private void reloadLayerAfterDownload() {
		CopyOfMap.this.osmap.resumeDraw();
		CopyOfMap.this.osmap.onLayerChanged(CopyOfMap.this.osmap.getMRendererInfo()
				.getFullNAME());
		try {
			CopyOfMap.this.osmap.initializeCanvas(TileRaster.mapWidth,
					TileRaster.mapHeight);
	...
	public void onFinishDownload() {
		runOnUiThread(new Runnable() {
			public void run() {
				...
				CopyOfMap.this.downloadTilesButton
	...
	public void onTotalNumTilesRetrieved(final long totalNumTiles) {
		runOnUiThread(new Runnable() {
			public void run() {
				CopyOfMap.this.tileWaiter.onTotalNumTilesRetrieved(totalNumTiles);
				CopyOfMap.this.totalTiles.setText(CopyOfMap.this
						.getText(R.string.download_tiles_06)
						+ " "
						+ totalNumTiles);
				double totalMB = totalNumTiles * 10 / 1024;
				CopyOfMap.this.totalMB.setText(CopyOfMap.this
